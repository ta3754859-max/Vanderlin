...
#define KNOW_COURT_LIST list(JOB_MONARCH, JOB_CONSORT, JOB_PRINCE, JOB_SERVANT, JOB_BUTLER, JOB_COURT_MAGE, JOB_COURT_PHYSICIAN, JOB_ARCHIVIST, JOB_GUARD_CAPTAIN, JOB_ROYAL_KNIGHT, JOB_GATEMASTER, JOB_MAN_AT_ARMS, JOB_DUNGEONEER, JOB_STEWARD, JOB_SQUIRE, JOB_MINOR_NOBLE)
#define KNOW_COURT_AGENT_LIST list(JOB_COURT_AGENT, JOB_MONARCH, JOB_CONSORT, JOB_PRINCE, JOB_SERVANT, JOB_BUTLER, JOB_COURT_MAGE, JOB_COURT_PHYSICIAN, JOB_ARCHIVIST, JOB_GUARD_CAPTAIN, JOB_ROYAL_KNIGHT, JOB_GATEMASTER, JOB_MAN_AT_ARMS, JOB_DUNGEONEER, JOB_STEWARD, JOB_SQUIRE, JOB_MINOR_NOBLE)
